-- The narrative profile reuses the existing bounded generation grant.
-- Keep every historical profile while allowing its nine-task budget.
BEGIN;
ALTER TABLE "hermes_research_runs" ADD CONSTRAINT "hermes_research_runs_generation_grant_check_narrative"
...
ALTER TABLE "hermes_research_runs" VALIDATE CONSTRAINT "hermes_research_runs_generation_grant_check_narrative";
ALTER TABLE "hermes_research_runs" DROP CONSTRAINT "hermes_research_runs_generation_grant_check";
ALTER TABLE "hermes_research_runs" RENAME CONSTRAINT "hermes_research_runs_generation_grant_check_narrative" TO "hermes_research_runs_generation_grant_check";
COMMIT;
