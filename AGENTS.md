> 开发导航：本目录保留 dirty main；当前交付位于 [.worktrees/onchip-video-release](.worktrees/onchip-video-release)，按该树 [AGENTS](.worktrees/onchip-video-release/AGENTS.md) 与 [CURRENT handoff](.worktrees/onchip-video-release/docs/handoff/2026-09-10-hermes-web-image-handoff.md) 续作。本页不维护另一份版本或待办。
