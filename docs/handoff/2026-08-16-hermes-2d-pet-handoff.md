...
> CURRENT 2026-09-08. Deployment of candidate `6cc6f466` failed after public and exact-release checks because retention preparation found an exited `09be` acceptance container still holding a read-only mount. Automatic rollback restored healthy production `134ebdea`; the deployment journal is cleared. The earlier approved video is historical evidence, not proof of the ordinary-user autonomous workflow.

## Exact versions
- Production is healthy at `134ebdea796b922ac07d9f29b6148b458b5e515f`; rollback remains `97aa06a542febf558a47cecbf6559bd0a6c876aa`. Candidate `6cc6f466` did not deploy. Log `1788860199633-c730685b-7af5-4db5-8922-0d20956d358c`; do not describe it as deployed.
- Release worktree `E:/Miscellaneous/XGS/.worktrees/onchip-video-release`, branch `codex/onchip-video-release`, `HEAD 6cc6f46646b6ad97005b071ec085262bccb111a3`, upstream `origin/codex/onchip-video-release`; PR107, CI `34209642581` passed. The concurrent dirty `apps/agent-worker/src/extractor.ts` belongs to another worker; do not overwrite it.
...
- Next: ECS-focus-validate the four extractor-prompt changes and deploy a new candidate. The old uploaded source must not be retried; use the prepared normal-user `qualityv2` upload. Never perform destructive schema rollback or delete run data.
