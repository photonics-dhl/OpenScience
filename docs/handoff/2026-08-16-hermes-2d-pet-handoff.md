...
- Branch / local implementation / repository main: `codex/scansci-default-capability` / `36f985c59c44c85c84ed242ca890ad6a5b7ce01e` / `463c8e3a2a80138cda2d669c370c0481ed4c0877`；远端仅保留 `main`。
...
20. Task 9 fixes 至 `36f985c` 已覆盖 descriptor Secret、HTTPS/DNS/NAT64、精确上游串行与 negative cache、EFBIG partial cleanup、共享 100 MiB soft+hard RLIMIT、exact source-temp rename 和 256 MiB tmpfs/verifier。全仓本机 `2112 pass / 21 platform skips / 0 fail`，Linux CI 须执行 RLIMIT/child 继承；open P0/P1 = 0。Task 10 部署前确认 targetless durable ScanSci tasks = 0；非零阻断，不自动 migration。
