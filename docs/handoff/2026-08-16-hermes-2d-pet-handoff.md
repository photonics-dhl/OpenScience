...
- Branch / local implementation / repository main: `codex/scansci-default-capability` / `185d5d686e1fae4d07f281dc1f28382679afe76a` / `463c8e3a2a80138cda2d669c370c0481ed4c0877`；远端仅保留 `main`。
