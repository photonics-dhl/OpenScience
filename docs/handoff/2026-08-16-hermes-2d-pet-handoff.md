...
- Remote branch HEAD: `f922f37` (`ee514aa` feature + docs-sync + rejected 3D cleanup + bounded CI browser setup/test)
- Local `main`: `1bb2f6b` plus this version-tuple docs commit; deployed application commit remains `017bf1e`
