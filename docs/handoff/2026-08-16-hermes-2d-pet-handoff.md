...
## Version tuple
- Production/public:69ea938c8f822c2d1aee100ad6a7c5d62ec01bc1; rollback b361f4f7781b760583b3a312829877c4d6310e8a. CI34187601825, server Parser16/build/migrations/runtime/public release and post-checkup passed.
...
## Active / next
- New scene4 taskd7ce0396-52c3-4401-a07f-24ffa0f9a39a generated successfully but was visually rejected and API-marked rejected: nanoantenna became radio/satellite dishes. Actual compiled prompt lost physical subtype (faint gold antenna). Planner semantic-preservation/no-writing fix pending release; tests13/types/lint passed. Retain scenes0..3; next output scene-images-v2, video helper XGS_IMAGE_OUTPUT=scene-images-v2. No real video yet.
