...
## Git、生产与独立能力版本
- 应用production=3070f3c9ba73dd964f860aa6dddf9c4cde64179a，rollback=fe955bcf7e04b25844a8be326209eb3a8bff6ede；必要服务器构建/正式迁移/启动exit0，独立读回.release-id一致，日志tmp/narrative-scientific-replan-deploy-retry-20260921.log。首次Git传输SSH reset发生在服务切换前，原候选重试完成；未测试/预检/CI/本机构建。迁移20260922010000已生效，旧Worker在600秒grace内未退出；关闭循环/排空资源修复另由独立High审查，未部署，不打断模型任务。根main acd13a712549e62f8d4b0f3c2f8f064549e226b0，HEAD按Git定锚，worktree仅根+交付树。
