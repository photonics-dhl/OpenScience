...
## Git与部署
- application production=49b5ae162f288d27fd0ddd3d321ec54d1faef8d4，rollback=326f117ecd2a690dcb5f3c252df7295fa8a6ef7f；canonical release/onchip-production-line已推送该完整SHA，根main=62b83372e51285b31a65f89bc0fabeb88d7c09bf。手绘双Skill的原art规划/render接线随应用发布，定向CI 35832552646 success；部署脚本 --confirm --no-tests --skip-migrate --reuse-unchanged-capability-images exit0、release CAS/retention完成，跨能力功能探针明确跳过。原326f保留回滚。Chat provider bundle仍a6a27ef5，未重装或重启共享桥。
...
- 2026-09-23三风格真实效果：基于第二篇批准方案9a1b与原7 Claims，art-only学术1b9f、编辑99b9、淡彩修正版d3b5方案均获批准用于私有生图；三方案的科学字段/标签/叙述与父方案逐项相同，provenance实录handdraw-router/style v1。私有Chat PNG分别8140（656018 bytes，SHA256 6b09a42529463fc4d05518815d48637e97abc09b47a86273ee0fc64777c5de9d）、61aa（713661，bce066284ab74901507a4a5a5cc547969dba2643270ec2a8f334e4ebd1df51cc）、430e（1248711，a28df766a72b6e8dd16d7edfd97d929108cac7e1c2f15282e0a63b86bba8f2d4）；本机ignored tmp同名前缀图片已核哈希并看像素。5.6Sol High内部对照：编辑GO；学术NO-GO（20 nm标尺落在偏心斜侧而非最近相对内表面）；淡彩NO-GO（77误成777 nm且无来源脉冲波瓣）；均未走正式产品审图或公开。淡彩首份方案be15错误地让电子不接触光带，生图前修正为d3b5；be15保留作证据。手绘表现skill v2已加入针对数值、标尺端点和无来源装饰的定向指导，本地5项测试/worker类型检查通过；v2尚未部署、未获新图效果，不能说根治模型错误。原认可/旧图保留。Domain管理员按已授权额度使用幂等账本：先2 credits，再4 credits，淡彩修复追加1 credit，均有审计；各方案/图实际扣1。旧scene-image/presentation-generation fixture/断言及主线CI lint 72项为单独债务，定向CI不覆盖它们。
