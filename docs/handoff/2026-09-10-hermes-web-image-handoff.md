...
## Git、部署与当前边界
- 当前应用生产/rollback：d7678b97ccc0f0528c4eef2a01921f049eafca74 / c0b55a84560afd17c6be839d68c7940f98389c52；canonical branch release/onchip-production-line。Hermes art 结构修复 [CI 36116799049](https://github.com/photonics-dhl/OpenScience/actions/runs/36116799049) success，应用部署 exit0、.release-id=d7678b97；--no-tests 跳过无关能力探针。网页桥兼容候选 5b7822d0 已推送、[CI 36123227015](https://github.com/photonics-dhl/OpenScience/actions/runs/36123227015) success，尚未部署；文档提交不需要部署。
...
|---|---|
| 第一篇机制图 / 1、5 | RO 9067a2d5，6 维/6 Claim/58 Evidence；旧方案 5226fcf5 与正式 6Pro accepted 图 8bbcfd9b（hash 778815c8…）仍在[公开 OSR-2026-000023/v/3](https://openscience.428312321.xyz/research/OSR-2026-000023/v/3)。私有 v10 草稿 eb8b3db7 复用六维/Claim/Evidence；新图 31c、3f1、cb4、1cd、7d9、a38 均正式 blocked 或人工 NO-GO。用户认可旧 cb4 的暖纸墨线风格，不认可物理含义。Hermes art-only 修订 9df66c13 已批准，科学字段与 41e0df85 逐项全等，明确空孔与并列分量、不用印章；仍无该方案 PNG。生图 b9ebc05e、667494f6 均在 page_selection 阶段 `IMAGE_COMPOSER_NOT_FOUND` 且 spool 证明 prompt 未提交；保留两次失败记录，不再盲重发。旧公开与原 PDF 保留。 |
...
- 2026-09-25 结构修复 f64674d7 与 `label N` 越界校验已随 d7678b97 部署。新同源科学修订 80673845 成功；首个自称 art-only 的 6a60ea53 实际漏传 `revisionMode:'art'`，不可归咎于机制。正确 art-only 41e0df85 与聚焦修订 9df66c13 均保持科学字段全等，后者 approved。新图 b9ebc05e、667494f6 均在提交 prompt 前失败；服务器新 Chat 页已登录，但旧 `#prompt-textarea`/profile testid 消失，现用 role textbox `Ask ChatGPT`、`Add files and more`、`Send` 与新模型二级菜单。5b7822d0 兼容候选保留旧页面路径及不重发门禁，node --check、diff --check 和独立 High GO；[CI 36123227015](https://github.com/photonics-dhl/OpenScience/actions/runs/36123227015) success，未安装 provider。参考图上传完成态仍待真实验证。
...
- 下一步先等候选 CI，再从干净推送 SHA 更新应用与独立网页 provider，核对实际新页，然后只发一个有来源的私有 9df66c13 生图任务；拿到真实 PNG 后走 5.6 Sol 正式像素审图与人工核图，科学/叙事不过关则保持私有。随后逐图改进第一篇机制关系与第二篇脉冲形成的阅读主线；风格是手段，不设置三类白名单。保留原文疑点回读/跨任务经验、定量几何核验、Fig.2 历史处置及当前失败资产。旧 bridge 晚于 30 秒取得 URL 的真实案例尚未实测。
