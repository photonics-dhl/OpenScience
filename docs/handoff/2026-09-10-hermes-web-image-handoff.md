...
- `bdf0d3fa` 已修复 structured illustration 绕过 render 设计 skill 的断点并部署；定向 typecheck 被既有跨包导出漂移阻断，未扩大测试。期刊式重做 `6d69159a-169e-4ebd-be15-80be97462fcc` 后，用户指出构图、字体仍平淡且信息量有限；最新 art-only 底稿 `6c45d774-24ed-4d18-92fc-f3ac4cd2eebd` 已批准，图片 `479cd958-6fab-4203-bab1-d5ad0e97f262` succeeded/draft，已导出 `tmp/research-illustration-academic-editorial-type-479cd958.png`，待用户审美确认。
