...
- 用户指出前版背景黄白混杂，已定位为多背景描述造成的模型分层；API 还暴露 storyboard instruction 上限 1000 字符。压缩为 918 字符的单背景硬约束后，底稿 `d45bea27-1147-4bfc-9e17-fe8830f39e6e` 已批准，图片任务 `3930c143-2c25-4067-85dc-1627070ec039` succeeded/draft，已导出 `tmp/research-illustration-academic-single-background-3930c143.png`。明确整版唯一 `#F7F8F6` 背景，区域色仅限中心图内；待用户审美确认。
