...
- **Done:** 四个 UI 原语与中英消息；workbench/evidence/status/focus/spacing/type/radius token；TDD 18/18 + web typecheck；Playwright 三视口截图；Figma 30 variables、1 effect style、4 components、6 screen skeletons。
