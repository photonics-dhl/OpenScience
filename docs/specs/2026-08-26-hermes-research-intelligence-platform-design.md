...
- Taskmaster `hermes-research-intelligence` Tasks 1–8 均已部署，完成计数 8/12。Task 8 已在 release `4c73469fe24abe685054f1d917d452adc5371d35` 通过 exact CI、ECS parser acceptance 与真实 Claim/Evidence/review/publish 旅程；下一产品任务是 Task 9 Claim-first 公开 RO，Task 10 dependency-ready。
...
- 生产 core 当前仓库迁移 `30/30`、search `2/2`；core active ledger 含需保留的历史兼容记录，failed migration 为 0。core/search 连接、迁移、物理隔离与健康探针独立。
