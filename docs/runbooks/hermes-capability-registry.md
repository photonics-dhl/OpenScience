...
2026-09-21候选：独立配图页64aa264e漏版本上下文已补；原图复用现有Artifact上传→artifactId登记draft→人工来源审核→approved reuse，不另写对象/解码框架。新发布只排显式来源标记，旧公开不变，冻结来源保留回收保护。边缘取色标准化已在服务器对真实下载原图定向执行成功，深色新图待实际观察；Pro短CLI已完成真实读写回合。尚未部署/新生图/审批发布，具体证据见CURRENT。
