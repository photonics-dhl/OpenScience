...
| Production `agent-worker` | 已注入 | 已注入；供应商额度耗尽 | 已注入；真实任务成功，连续请求可被 429 节流 | `80db41e…` 运行 official MCP client；migration 34、17 tools/真实 Worker OA 已生产，官方 cookie import/机构 PDF pending |
