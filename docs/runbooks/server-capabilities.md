> HISTORICAL — 本文件保留旧 main 的服务器记录。当前清单见 [交付树服务器能力](../../.worktrees/onchip-video-release/docs/runbooks/server-capabilities.md)，具体版本只见该树 CURRENT handoff；下方安装/状态描述不能当作当前指令。
