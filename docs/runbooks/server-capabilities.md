...
| 能力 | 已有位置 / 入口 | 状态与复用方式 |
|---|---|---|
| 生产应用 | `/opt/openscience`；`openscience-prod-{web,api,agent-worker}-1` | 2026-09-10 release `d850fadbbe579481f68ab4d57f53f6910dee4120`，rollback `0c635525e3bffcd7a30199b0770cc3af37d3bc1b`；真实网页生图任务已回传产品草稿。不要混用本地候选与线上版本 |
