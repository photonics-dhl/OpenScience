...
- 第一篇 abe8 草稿的“小印章”科学/艺术字段冲突仍未放行；同源修订 63e60709 于 art 阶段三次结构化输出失败，未产生方案或图片。现有 Hermes 技能与单幕 art 提示、Gateway 重试反馈已针对这次格式错误修复并推送 f64674d7，17/17 定向测试、Worker typecheck、独立 High GO；[CI 36116799049](https://github.com/photonics-dhl/OpenScience/actions/runs/36116799049) success，生产未更新，真实任务效果待验证。不重跑全文分析或旧失败任务。
