...
- 像素审批门禁已随09ad发布，生产私有草稿仍为draft且canApprove=false；CI 35853693143通过，尚无新公开版本。正式5.6 Sol审图候选已完成协议、路由、已有PNG原字节复用和定向测试，独立High审查/服务器独立账号设备登录进行中；未部署、未作正式审图，不将内部咨询当审核收据。准确状态见[CURRENT](handoff/2026-09-10-hermes-web-image-handoff.md)。
