...
- 用户授权保留会话继续；新版站内入口和Hermes版本上下文已实际成功。真实Fig.1上传/来源核对/原样reuse方案已通过，复制任务待读回；新封面分镜暴露科学字段超长，Pro桥短任务和High定向审查支持反馈修复；发布选择候选避免旧成品自动混入，待服务器部署。未跑测试/预检/CI，未新Chat图或公开。版本、证据与下一动作仅见[CURRENT](handoff/2026-09-10-hermes-web-image-handoff.md)。
