...
- 首篇v3已公开。第二篇最新4图1通过/2科学拒收/1渲染拒收，几何与条件分组提示已部署并由原页面提交新科学方案。第三篇技术子集恢复及队列/执行时限分离已High静态PASS并正常服务器构建上线，原页面202仅提交3生图+1已有PNG审阅，保留已审图和原科学方案。两篇新结果在途，reader/新公开版本尚未完成；精确状态和证据见[CURRENT](handoff/2026-09-10-hermes-web-image-handoff.md)。未测试/预检/CI/本机构建。
