...
- 自有页面隔离、正式 issues 到 art、仅恢复已有 PNG 审阅及30秒事务修复已交付；现有独立浏览器provider仍为574c。显式选Pro、额度拒绝分类、P2034有界重试及最多第二段review-only续审获独立High静态GO，已进入保留期刊线上代码的集成候选，尚未部署或实际观察；准确状态见 [Hermes CURRENT](handoff/2026-09-10-hermes-web-image-handoff.md)。
