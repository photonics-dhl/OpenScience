...
## 2026-09-20 — 沙箱恢复后补生产者路径与定期清理
- 268 日志归档后的沙箱成功证据沿用；本轮 home 仍353项，补全局/交付树产物归位规则、两历史脚本的归档路径及重跑保护，启用每日09点安静维护。未知归属资产保留，无新模型/测试/探针/部署；上游 argv 缺陷和桌面压缩续接仍未根治，后者仅新增静态定位。既有 Pro 审查与风格链路部署保持，证据、清理边界、回滚与交付差额见 [CURRENT](handoff/2026-09-10-hermes-web-image-handoff.md)。
