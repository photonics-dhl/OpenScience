...
- **版本边界**：功能修复 `ee514aa`、docs-sync `961b584`、rejected-3D cleanup `5a680b9` 与 CI browser-budget 修复 `dbcea0f` 已推送并更新 PR #3；本地 `main` 已同步 CI 修复，部署应用仍为 `017bf1e`，rollback 为 `aa1c8af`。用户自有未跟踪设计资产未移动、删除或提交。
