...
- 用户授权保留会话续作；真实Fig.1上传→核对→Hermes reuse→原字节copy→成品批准已完成，已认可Fig.3也完成页面批准。发布选图/长度反馈已部署，实际发布页默认空选6成品；新方案科学问题被人工拦住，沿原入口修订，未耗Chat生图/公开。style遗漏及过长修复反馈候选收口中；第三篇确认120000字符前置阻塞无合法恢复，不重复上传。未跑测试/预检/CI。版本、证据与下一动作仅见[CURRENT](handoff/2026-09-10-hermes-web-image-handoff.md)。
