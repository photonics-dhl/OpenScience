...
- 2026-09-23 用户明确必要测试/CI须运行、避免过度测试；交付树与根入口 AGENTS.md 已纠偏。项目适配的[手绘匹配](../.agents/skills/openscience-handdraw-router/SKILL.md)与[表现](../.agents/skills/openscience-handdraw-style/SKILL.md)只接原学术/编辑/淡彩的 art/render。v1 定向5项测试、worker类型检查、docs lint及[交付分支CI](https://github.com/photonics-dhl/OpenScience/actions/runs/35832552646)通过，49b5已部署。第二篇同一已批准科学方案生成三张真实私有图：编辑图内部5.6Sol GO，学术图标尺端点错误、淡彩图77误写777 nm且添加无来源波瓣，均内部NO-GO。三方案结构化科学字段保持一致，实际像素却显示门禁不能省；已据此细化表现skill v2，本地5项定向测试和worker类型检查通过，CI/部署/真实效果仍待完成。正式产品审阅和公开未完成，详见 [CURRENT](handoff/2026-09-10-hermes-web-image-handoff.md)。旧分镜fixture与主线CI lint债务独立登记。
