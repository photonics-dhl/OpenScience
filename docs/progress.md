...
- 首篇v3已公开。第二篇4图科学拒收；第三篇标题依据失效且没有科学拒收锚点。来源恢复及同次末审反馈补接已静态High PASS、正常服务器构建启动完成；两篇原页面已各一次202恢复，等待新Hermes方案。用户要求优先发挥skills/MCP与学习反馈；已撤下未上线的默认6Pro末审候选，原任务已证实消费科学/设计skills，接下来修消费断点而非重复安装。后两篇reader/新公开版本未完成；精确状态和证据见[CURRENT](handoff/2026-09-10-hermes-web-image-handoff.md)。未测试/预检/CI/本机构建。
