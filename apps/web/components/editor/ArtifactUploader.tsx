  ...
  return (
    ...
    <section className="mt-10 border-t border-os-rule-dark pt-5" id="artifacts">
      <div className="flex items-center justify-between gap-4">
        ...
        <label className={`inline-flex min-h-10 items-center rounded-panel border border-os-rule-dark px-3 text-sm text-os-paper ${disabled || uploadPending ? 'cursor-not-allowed opacity-50' : 'cursor-pointer'}`}>
          {t('uploadArtifact')}
          <input
            ref={fileRef}
            className="sr-only"
