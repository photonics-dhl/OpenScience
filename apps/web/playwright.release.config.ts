...
export default defineConfig({
  testDir: './test/e2e',
  testMatch: ['product-release.spec.ts', 'claim-first-public-ro.spec.ts', 'academic-identity-recovery.spec.ts', 'research-continuation.spec.ts', 'presentation-workbench.spec.ts', 'research-overview.spec.ts'],
  timeout: 60_000,
  fullyParallel: false,
  workers: 1,
