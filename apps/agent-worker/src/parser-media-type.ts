...
const PARSER_MEDIA_TYPES: Readonly<Record<string, ParserMediaTypeDefinition>> = Object.freeze({
  ...
  pptx: definition('application/vnd.openxmlformats-officedocument.presentationml.presentation', 'application/vnd.openxmlformats-officedocument.presentationml.presentation'),
  ...
  html: definition('text/html', 'text/html', 'text/plain'),
  htm: definition('text/html', 'text/html', 'text/plain'),
