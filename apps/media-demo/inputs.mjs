...
export async function validatePaths(inputArgument, outputArgument) {
  ...
  return { input, output, audioMode, scene3Artwork, storyboard, renderMode: storyboard?.profile === 'onchip-field-sampling-v1' ? 'onchip-field-sampling-animation' : storyboard?.profile === 'content-driven-v1' ? 'content-driven-animation' : storyboard ? 'illustrated-storyboard-preview' : 'd2nn-scientific-animation' };
}
