...
test('upstream patch connects the controlled institutional context and reaps browser workers', async () => {
  ...
  try {
    ...
    await writeFile(join(packageRoot, '_publisher_strategies_core.py'), [
      ...
      '    ctx = FixtureContext(fail_new_page=scenario != "happy")',
      '    created.append(ctx)',
      '    return ctx',
    ...
    const institutionProbe = [
      ...
      'assert hasattr(browser_engine, "_linux_descendant_pids")',
      ...
      '    assert browser_engine._linux_descendant_pids(100, proc_root) == [101, 102, 103]',
      'finally:',
      '    shutil.rmtree(proc_root)',
      'real_os = browser_engine.os',
      'real_signal = browser_engine.signal',
      'real_descendants = browser_engine._linux_descendant_pids',
      'class PosixOs:',
      '    name = "posix"',
      '    kills = []',
      '    @classmethod',
      ...
      'browser_engine._linux_descendant_pids = lambda pid: [201, 202]',
      'tree_proc = browser_engine.FixtureProc()',
      'try:',
      '    browser_engine._tree_kill(tree_proc)',
      '    assert PosixOs.kills == [202, 201]',
      '    assert tree_proc.killed',
      'finally:',
      '    browser_engine.os = real_os',
      '    browser_engine.signal = real_signal',
      '    browser_engine._linux_descendant_pids = real_descendants',
      'def terminated(proc):',
      '    if os.name == "nt":',
