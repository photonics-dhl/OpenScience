...
| `docs/runbooks/deployment.md` | 部署 runbook（cloud-sync/迁移/seed/nginx/验证、Parser 隔离与版本化资产）；§5.3–5.9 登记 Optical 与 Hermes 生产发布 | CURRENT；部署前后必须记录 release/rollback 与硬健康证据 |
