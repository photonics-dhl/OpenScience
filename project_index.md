...
| `docs/specs/2026-08-19-hermes-wanko-live2d-design.md` | Wanko renderer、`360/200px`、Research Folio；§13.3 锁定 12 项动作/Live2D/双语短句；§13.4 纠正断裂气泡、伪嘴部锚点、悬空页注与菜单遮字 | **CURRENT Hermes visual/guide design / §13.4 APPROVED, AWAITING WRITTEN REVIEW**；production `8ed2f3c` VISUALLY REJECTED |
...
| `docs/handoff/2026-08-16-hermes-2d-pet-handoff.md` | Hermes Wanko Live2D 唯一 CURRENT 交接：§13.4 视觉纠错、Research Folio release、本地/远端/ECS version tuple、约束与验收入口 | **CURRENT / compact active-memory**；application `1b3bada`；production `8ed2f3c` visually rejected，rollback `7165e9b` |
