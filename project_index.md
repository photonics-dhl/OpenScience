...
| `docs/runbooks/deployment.md` | 部署 runbook（cloud-sync/迁移/seed/nginx/验证、Parser/BGE 隔离、Windows 显式 Git Bash 专用密钥调用与版本化资产）；§5.38 acceptance/FD9 transaction，§5.39 parser recovery，§5.40 inventory，§5.41 cleanup/retention，§5.43 Task 8 release/eval hygiene | **CURRENT**；application/release `4c73469`，rollback `cf68bfa7`，根盘 36G/26% 且 production GREEN |
