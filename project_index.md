...
| `docs/handoff/2026-08-16-hermes-2d-pet-handoff.md` | Hermes Wanko Live2D 唯一 CURRENT 交接：§13.7 短视口与上游重排修复、本地/远端/ECS version tuple、约束与验收入口 | **CURRENT / compact active-memory**；application/release/rollback `5323ba8` / `bf54eaa` / `6b804f7` |
...
| `docs/runbooks/deployment.md` | 部署 runbook（cloud-sync/迁移/seed/nginx/验证、Parser 隔离、Windows Git Bash 专用密钥调用与版本化资产）；§5.23 登记 Hermes 短视口 collision correction | CURRENT；ECS release/rollback `bf54eaa` / `6b804f7`；application `5323ba8`，public Hermes `9/9` |
