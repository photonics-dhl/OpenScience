...
> **CURRENT 2026-09-08:** production9236dbf7 / rollbackdb4e9208；部分原文提取、23来源确认及服务器分镜已完成，当前run待审。内容驱动视频整改进行中，尚无当前run图片或视频。
...
| `docs/handoff/2026-08-16-hermes-2d-pet-handoff.md` | **CURRENT active-memory**；production9236dbf7 / rollbackdb4e9208；内容驱动视频整改进行中，当前run待分镜审核，非旧样片验收 |
