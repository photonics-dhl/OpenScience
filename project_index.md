...
| `apps/web/test/visual/shots.mjs` | Task 15 Landing production browser gate：原生 1672×941 与 390×844 normal/reduced、唯一 main/h1/shared surface、导航/CTA/Latest Research、overflow/errors/focus、bounded pointer response，并对 desktop reduced accepted fixture 做 exact pixel identity | 本地门禁与 Task 19 公网 desktop/mobile normal/reduced/idle/pointer 回归 GREEN |
...
| `docs/runbooks/deployment.md` | 部署 runbook（cloud-sync/迁移/seed/nginx/验证、deploy.sh/DNS-01 实证）；§5.3 登记 Task 19 shared optical overlay、real `+5px` follow/10px cap、RTX desktop evidence、手机风险豁免与上线前后硬门禁 | 已部署：`b6a41da`，rollback `cd5be36`，backup `280K 7/7`，公网回归 GREEN |
