...
| `docs/handoff/2026-08-16-hermes-2d-pet-handoff.md` | Hermes Wanko Live2D 唯一 CURRENT 交接：§13.8 detached 右侧停靠与 protected fallback、本地/远端/ECS version tuple、约束与验收入口 | **CURRENT / compact active-memory**；candidate `9aef5c4`，production application/release/rollback `5323ba8` / `bf54eaa` / `6b804f7` |
...
| `docs/runbooks/deployment.md` | 部署 runbook（cloud-sync/迁移/seed/nginx/验证、Parser 隔离、Windows Git Bash 专用密钥调用与版本化资产）；§5.24 登记 Hermes detached composition correction | CURRENT；candidate `9aef5c4`，ECS 仍为 release/rollback `bf54eaa` / `6b804f7`；deployment pending |
