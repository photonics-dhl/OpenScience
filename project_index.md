...
| `apps/web/public/hermes/live2d/{NOTICE.md,live2dcubismcore.min.js,wanko/**}` / `apps/web/test/hermes-live2d-asset-contract.test.ts` / external `C:/Users/Mac/AppData/Local/OpenScience/Live2D/wanko-genie-v1/runtime-v09-export-20260823/` | v09 SDK 4.0 runtime 已进入仓库：两张 texture zero-alpha RGB clean、12 motion 参数兼容、manifest 闭合；active renderer 已删除造成碎片的 Pixi procedural navigator，只保留单一 Cubism model/canvas | **CURRENT local release candidate / NOT DEPLOYED**；母版 SHA `BA111D4E...1121ADD` 未改，fresh aggregate gate GREEN，production 仍 `06072c1`，仅待 clean commit 与 operator 发布许可记录 |
