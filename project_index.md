...
| `docs/specs/2026-08-19-hermes-wanko-live2d-design.md` | Wanko 第一阶段验证角色；§10 原生灯/烟雾托座；§11 统一 semantic performance beat、`336/176px` movable work-assistant 层级与双语 optical-editorial 气泡系统 | **CURRENT Hermes visual/guide design**；Task 20 本地候选 `c123a5a`，Phase 2 Cubism 新动作待真实画面判断 |
