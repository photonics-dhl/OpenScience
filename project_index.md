...
| `docs/plans/2026-08-18-readable-workspace-hermes-guidance-plan.md` | 可读性基础→代表页面→完整 Hermes footprint 避让→edit-before-accept/缺失证据→语义动作→公网 blank RO gate→ECS checkpoint 的 TDD 实施链 | **CURRENT execution plan**；reviewed implementation `c8903d5` 已推送，ECS checkpoint next |
...
| `docs/handoff/2026-08-16-hermes-2d-pet-handoff.md` | Readable Workspace / Hermes 唯一 CURRENT 交接：当前入口、branch/candidate/release/rollback、约束与单一 next action | **CURRENT / compact active-memory**；`c8903d5` reviewed/pushed，待 ECS checkpoint |
