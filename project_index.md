...
| `docs/plans/2026-08-27-hermes-semantic-retrieval-bge-m3-plan.md` | Taskmaster Task 6 的 ECS-first TDD 实施计划：BGE-M3 source-lock/CPU bake-off、独立 search migration、locator-safe chunk、BM25+dense RRF、降级、独立备份恢复与生产验收 | **CURRENT / EXECUTION STARTED**；Tasks 1、3 harness/chunking GREEN，Task 2 exact-SHA ECS forward/rollback/redeploy GREEN；模型与生产 route 均未安装或启用 |
