...
> **CURRENT 2026-09-11:** production `52a52829` / rollback `d6dce2e2` / browser provider `f4832487`。连续共编工作台、草稿同步、选择性继承和两栏CSS已部署；实际v3保存刷新保持一致。核心图方案已修订批准，图片与公开发布待完成；唯一入口：`docs/handoff/2026-09-10-hermes-web-image-handoff.md`。
