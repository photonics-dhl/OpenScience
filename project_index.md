...
| `docs/runbooks/deployment.md` | 部署 runbook（cloud-sync/迁移/seed/nginx/验证、Parser/BGE 隔离、Windows 显式 Git Bash 专用密钥调用与版本化资产）；§5.38 acceptance/FD9 transaction，§5.46 Task 10 provider/PDF/GC journey | **CURRENT**；application/release `6893318`，rollback `c435c4c`，根盘 36G/25% 且 production GREEN |
