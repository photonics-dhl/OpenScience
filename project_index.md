...
| `docs/plans/2026-08-29-production-release-retention-plan.md` | active+rollback 机器身份、durable pending intent 与精确 release retention 实施计划 | **IMPLEMENTED CANDIDATE / CI PENDING**；rollback marker 已 ECS bootstrap；禁止 broad prune，自动范围仅旧 release/capability/精确 tag |
| `docs/plans/2026-08-29-hermes-research-identity-routing-plan.md` | Taskmaster Task 7：注册身份、可纠正兴趣、服务端 InterestContext、Hermes 静默路由与生产真实旅程 | **CURRENT / READY TO EXECUTE**；复用既有 profile 模型，不引入模式切换 |
