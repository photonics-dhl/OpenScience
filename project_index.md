...
| `docs/handoff/2026-08-16-hermes-2d-pet-handoff.md` | 唯一 compact CURRENT 交接：Research Intelligence 生产基线、CPU parser cascade 预部署阻断、固定约束与 version tuple | **CURRENT active-memory**；branch/HEAD `codex/hermes-wanko-live2d` / `6268be3`，production/rollback `e2c0eaf` / `8163f8b` |
