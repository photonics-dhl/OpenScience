...
| `docs/specs/2026-08-11-optical-lab-high-fidelity-design.md` | `Science evolves.` 原型高保真重构：OGL WebGL2 多通道、全尺寸排版合同、MSDF/flowmap/GPGPU/HDR 五层静态光场、4px 轻交互与静态降级；含 2026-08-13 单壳径向能量构图证据修正 | 能量构图与独立复审本地 GREEN，待真机性能与用户视觉终验；未替换生产 `/`、未部署 |
