...
| `docs/handoff/2026-08-16-hermes-2d-pet-handoff.md` | Readable Workspace / Hermes 唯一 CURRENT 交接：当前入口、branch/candidate/release/rollback、约束与单一 next action | **CURRENT / compact active-memory**；release `06072c1` 已完成公网验收 |
