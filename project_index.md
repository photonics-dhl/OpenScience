...
> **CURRENT 2026-09-11:** production/provider `6a9f650e` / rollback `3ee10d6e`。实际页面已显示1/6、限流与成果入口；静默刷新已部署。第二批页面/prompt小修候选未部署，图片质量待改善。唯一入口：`docs/handoff/2026-09-10-hermes-web-image-handoff.md`。
