...
| `docs/plans/2026-08-24-research-folio-product-system-plan.md` | Research Folio 的合同、共享 shell、Hermes 锚定几何、identity/Dashboard/create/RO/public/admin 迁移、60-case production browser 门禁与 immutable ECS 发布链 | **COMPLETE**；release `33418fd`, rollback `2abfe42` |
...
| `docs/handoff/2026-08-16-hermes-2d-pet-handoff.md` | Hermes Wanko Live2D 唯一 CURRENT 交接：Research Folio whole-product release、视觉复核 hotfix、本地/远端/ECS version tuple、约束与验收入口 | **CURRENT / compact active-memory**；production `33418fd`，rollback `2abfe42` |
