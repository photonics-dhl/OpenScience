...
| `docs/plans/2026-08-17-hermes-workspace-companion-motion-plan.md` | Hermes Workspace Companion 八任务实施计划：事实源、行为导演、四层 mixer、锚点/路径/停靠、全局 stage、字段引导、diff、默认 full/常驻控制与真实 release gate | **CURRENT execution plan**；核心范围部署 `1b76b46`，高级偏好 UI 与两信号提示仍待后续 |
