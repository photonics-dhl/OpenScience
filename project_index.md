...
> **CURRENT source/deployment anchor（2026-08-24 13:02 +08）：** working branch / deployed HEAD `codex/hermes-wanko-live2d@02d3dd9`，keyboard-navigation hotfix 位于未提交工作树；local main / origin main `c60ffdd` / `7eb2f5b`；ECS release / rollback 为 `02d3dd9` / `5f4e73c`。只有本锚点与主题唯一 CURRENT handoff 可决定当前状态；不得把 hotfix candidate 或后续 docs-only HEAD 冒充 application release。
