...
| `scripts/design/prompt-manifest.mjs` / `prompt-manifest.test.mjs` | 设计资产批准 Markdown 的纯提示解析器与无网络 Node 测试；将 `MiniMax Prompt` 和 `Negative Prompt` 的首个 text 区块合并为图片 API 的单一 prompt | 活文档 |
