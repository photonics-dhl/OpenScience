...
| `apps/agent-worker/src/extractor.ts` / `apps/agent-worker/test/extractor.test.ts` | 科学原文提取、连续来源窗口与精确来源绑定 | 1df9f617已部署，真实结果仍截断；exact-quote候选修复中，未运行测试，见CURRENT handoff |
