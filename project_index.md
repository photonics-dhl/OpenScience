...
| `docs/design-assets/figma/2026-08-08-step8-core-primitives-v1.png` | Figma `02 Components` 首批 Card/Badge/Input 双表面与状态集合截图；作为组件批次视觉确认与 API 对账证据 | Awaiting batch visual approval |
