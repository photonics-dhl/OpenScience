...
| `docs/specs/2026-08-30-scansci-default-capability-design.md` | 一次浙江大学 CARSI 认证→持久 Hermes 默认文献下载；可选 root-only 账号 Secret、隔离 legal-only 服务/认证 helper、统一 acquisition API、Personal Space/Hermes/RO 多入口与 ECS 验收 | **CURRENT APPROVED DESIGN / USER WRITTEN-SPEC REVIEW PENDING**；Task 10 completion gate，Task 11 blocked |
